...
%% Sound Samples
[storm, fs_storm] = audioread('storm.wav');
storm1 = storm(8555400:10584000,1);
% claims to be guitar
...
figure;
hold on
plot(output_feedback);
plot(outputnorm);
plot(output_feedback - outputnorm)
legend("feedback", "No Feedback","difference");
hold off
...
depth = 0.8;
feedback = 0.7;
[output]=delay(constants,inSound(:,1),depth,delay_time,feedback);
